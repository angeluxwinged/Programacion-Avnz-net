...
<body>
    <div class="container" id="container_app">
		...
		<div v-else>
			<div v-if="showFormAddUser">
				<button type="button" v-on:click="showFormAddUserChanger">Add New User</button>
			</div>
			<div v-if="!showFormAddUser">
				<form action="">
					<div class="container-addUsers">
						...
						<div class="add-info">
							...
							<button type="button" v-on:click="showFormAddUserChanger">Cancelar</button>
						</div>
					</div>
				</form>
			</div>
